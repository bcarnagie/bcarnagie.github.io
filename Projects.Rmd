...
## The Impact of Insurance Coverage on Hospital Outcomes 

*May 2024*  
**Machine Learning Project**

*Research Question:* How does the length of stay vary by type of insurance coverage in surgical patients?


- Utilized the SPARCS dataset, capturing detailed patient-level information including characteristics, diagnoses, treatments, services, and charges across hospital inpatient stays and outpatient visits.
- Analyzed key variables such as age group, severity of illness, risk of mortality, and insurance type.
- Applied feature selection using Lasso Regression.
- Utilized propensity score estimation with Random Forest and conducted propensity score matching for outcome analysis.
- Provided insights into how insurance type correlates with patient length of stay in surgical settings, contributing to discussions on healthcare access and resource allocation.
